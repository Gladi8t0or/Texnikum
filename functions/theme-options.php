...
function custom_theme_options() {
	...
	$custom_settings = array(
		...
		'sections'        => array(
			array(
				'id'    => 'option_types',
				'title' => __( 'Примеры настроек', 'theme-text-domain' ),
			),
			...
			array(
				'id'    => 'direktor-text',
				'title' => 'Обращение к посетителям сайта',
			),
		),
		'settings'        => array(
		...
		array(
				'id'           => 'direktor-who',
				'label'        => 'Напишите ФИО вашего директора',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'who-direktor',
				'rows'         => '',
				'post_type'    => '',
				'taxonomy'     => '',
				'min_max_step' => '',
		...
		array(
				...
				'desc'         => 'Напишите сюда ваш текст обращения к посетителям сайта',
				'std'          => '',
				'type'         => 'textarea',
				'section'      => 'direktor-text',
				'rows'         => '',
				'post_type'    => '',
				'taxonomy'     => '',
				'min_max_step' => '',
